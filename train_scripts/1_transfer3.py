...
def SubModel_7ch(input_img):
    ...
    Econv2_2 = BatchNormalization(name = "Enorm22")(Econv2_2)
    Epool2= MaxPooling2D(pool_size=(2, 2),strides=(2,2), padding='same', name = "block2_pool1")(Econv2_2)
    Econv3_1 = Conv2D(8, (3, 3), activation='relu', padding='same', name = "block3_conv1")(Epool2)
    Econv3_1 = BatchNormalization(name = "Enorm31")(Econv3_1)
    Econv3_2 = Conv2D(16, (3, 3), activation='relu', padding='same', name = "block3_conv2")(Econv3_1)
    Econv3_2 = BatchNormalization(name = "Enorm32")(Econv3_2)
    Epool3 = MaxPooling2D(pool_size=(2, 2),strides=(2,2), padding='same', name = "block3_pool1")(Econv3_2)
    # NECK
    Nconv1 = Conv2D(32, (3,3),padding = "same", name = "neck1" )(Epool3)
    Nconv1 = BatchNormalization(name = "Nnorm1")(Nconv1)
    Nconv2 = Conv2D(32, (3,3),padding = "same", name = "neck2" )(Nconv1)
    Nconv2 = BatchNormalization(name = "Nnorm2")(Nconv2)
    # DECODER
    up1 = Conv2DTranspose(32,(3,3),strides = (2,2), activation = 'relu', padding = 'same', name = "upsample_1")(Nconv2)
    up1 = BatchNormalization(name = "Dnorm11")(up1)
    Upconv1_1 = Conv2D(32, (3, 3), activation='relu', padding='same', name = "Upconv1_1")(up1)
    Upconv1_1 = BatchNormalization(name = "Dnorm12")(Upconv1_1)
    Upconv1_2 = Conv2D(32, (3, 3), activation='relu', padding='same', name = "Upconv1_2")(Upconv1_1)
    Upconv1_2 = BatchNormalization(name = "Dnorm13")(Upconv1_2)
    up2 = Conv2DTranspose(16,(3,3),strides = (2,2), activation = 'relu', padding = 'same', name = "upsample_2")(Upconv1_2)
    up2 = BatchNormalization(name = "Dnorm21")(up2)
    up2 = keras.layers.concatenate([up2, Econv2_2], axis=3, name = "merge_2")
    Upconv2_1 = Conv2D(16, (3, 3), activation='relu', padding='same', name = "Upconv2_1")(up2)
    Upconv2_1 = BatchNormalization(name = "Dnorm22")(Upconv2_1)
    Upconv2_2 = Conv2D(16, (3, 3), activation='relu', padding='same', name = "Upconv2_2")(Upconv2_1)
    Upconv2_2 = BatchNormalization(name = "Dnorm23")(Upconv2_2)
    up3 = Conv2DTranspose(8,(3,3),strides = (2,2), activation = 'relu', padding = 'same', name = "upsample_3")(Upconv2_2)
    up3 = BatchNormalization(name = "Dnorm31")(up3)
    Upconv3_1 = Conv2D(8, (3, 3), activation='relu', padding='same', name = "Upconv3_1")(up3)
    Upconv3_1 = BatchNormalization(name = "Dnorm32")(Upconv3_1)
    Upconv3_2 = Conv2D(8, (3, 3), activation='relu', padding='same', name = "Upconv3_2")(Upconv3_1)
    Upconv3_2 = BatchNormalization(name = "Dnorm33")(Upconv3_2)
    # final output
    decoded = Conv2D(3, (3, 3), activation='sigmoid', padding='same', name = "Ouput_layer")(Upconv3_2)
    #
...
if not os.path.exists('models'):
    os.makedirs('models')
fmodel.save(os.path.join('models','1_transfer3.h5'))
